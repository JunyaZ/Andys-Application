...
class DatabaseInterface (Frame):    
    ...
    def __init__(self):
        ...
        """Create table"""
        #name column
        self._ProjectedCol = Listbox(self._tablePane, width = 10, selectborderwidth =2, height = 15, yscrollcommand = scrollbar.set)
        ...
        #city column
        self._DatesCol = Listbox(self._tablePane,selectborderwidth =2, width = 10, height = 15)
        ...
        #street column
        self._iCol = Listbox(self._tablePane, selectborderwidth =2,width = 10, height = 15, yscrollcommand =scrollbar.set)
